...
namespace Linq
{
    ...
    public static class ElementOperations
    {
        ...
        public static Product FirstElement()
        {
            ...
            var firstElement = products.FirstOrDefault(product => product.ProductId == 11);
            return firstElement;
        }
        ...
        public static string FirstMatchingElement()
        {
            ...
            var startsWithO = strings.Where(first => first.StartsWith("o"));
            return startsWithO.FirstOrDefault();
        }
        ...
        public static Product MaybeFirstMatchingElement()
        {
            ...
            var findProduct = products.Where(product => product.ProductId == 789).FirstOrDefault();
            if(findProduct == null)
            {
                return null;
            }
        ...
        public static int ElementAtPosition()
        {
            ...
            var secondGreaterThan5 = numbers.Where(num => num > 5).ElementAtOrDefault(1);
            return secondGreaterThan5;
        }
        ...
        public static string LastMatchingElement()
        {
            ...
            var lastElementContainsO = strings.LastOrDefault(str => str.Contains("o"));
            return lastElementContainsO;
        }
        ...
        public static string SingleMoreThanOneMatchingElement()
        {
            ...
            var oCount = strings.Count(str => str.Contains("o"));
            ...
            {
                throw new InvalidOperationException("More than one element contains 'o'!");
            }
        }
